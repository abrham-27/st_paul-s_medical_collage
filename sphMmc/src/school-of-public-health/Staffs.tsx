...
export default function PublicHealthStaffs({ onBack, onViewProfile }: Props): JSX.Element {
  const [staffs, setStaffs] = useState<AcademicStaffMember[]>([]);
  const [loading, setLoading] = useState(true);
  const [search, setSearch] = useState('');

  useEffect(() => {
    apiService.getAcademicStaffs('public_health')
      ...
      <div className="staffs-hero">
        <div className="staffs-container">
          ...
          <div className="staffs-hero-content">
            ...
            <p className="lead">Meet the dedicated faculty shaping the future of public health at SPHMMC.</p>
          </div>
        </div>
      </div>
