...
export default function NursingStaffProfile({ slug, onBack }: Props): JSX.Element {
  const [staff, setStaff] = useState<AcademicStaffMember | null>(null);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    apiService.getAcademicStaff('nursing', slug)
      ...
      <div className="staffs-hero">
        <div className="staffs-container">
          ...
          <div className="staffs-hero-content">
            <span className="badge">School of Nursing · Staff Profile</span>
