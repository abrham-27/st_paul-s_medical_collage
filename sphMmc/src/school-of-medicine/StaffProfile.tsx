...
export default function StaffProfile({ slug, onBack }: Props): JSX.Element {
  const [staff, setStaff] = useState<AcademicStaffMember | null>(null);
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    apiService.getAcademicStaff('medicine', slug)
      ...
      <div className="staffs-hero">
        <div className="staffs-container">
          ...
          <div className="staffs-hero-content">
            <span className="badge">School of Medicine · Staff Profile</span>
