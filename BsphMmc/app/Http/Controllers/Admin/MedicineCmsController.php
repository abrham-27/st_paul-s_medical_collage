...
class MedicineCmsController extends Controller
{
    public function overview()
    {
        $page = AcademicPage::getOrCreate('medicine', 'overview');
        return view('admin.medicine.overview', compact('page'));
    }
    ...
    {
        $page = AcademicPage::getOrCreate('medicine', 'partnership');
        return view('admin.medicine.partnership', compact('page'));
    }
