...
<div class="py-6 max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.academic-staffs.update', $academicStaff) }}" enctype="multipart/form-data" class="space-y-5">
            @csrf @method('PUT')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <select name="school_type" required
                        ...
                        <option value="medicine"      {{ old('school_type', $academicStaff->school_type) === 'medicine'      ? 'selected' : '' }}>School of Medicine</option>
                        <option value="nursing"       {{ old('school_type', $academicStaff->school_type) === 'nursing'       ? 'selected' : '' }}>School of Nursing</option>
                        <option value="public_health" {{ old('school_type', $academicStaff->school_type) === 'public_health' ? 'selected' : '' }}>School of Public Health</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="status" required
                            class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
                        <option value="active"   {{ old('status', $academicStaff->status) === 'active'   ? 'selected' : '' }}>Active</option>
                        <option value="inactive" {{ old('status', $academicStaff->status) === 'inactive' ? 'selected' : '' }}>Inactive</option>
                    </select>
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="full_name" value="{{ old('full_name', $academicStaff->full_name) }}" required
                       class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position', $academicStaff->position) }}" required
                           class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                <div>
                    ...
                    <input type="hidden" name="department" id="department_input" value="{{ old('department', $academicStaff->department) }}">
                    <input type="text" id="department_custom_input" value="{{ old('department', $academicStaff->department) }}"
            ...
            <div>
                ...
                <input type="text" name="qualification" value="{{ old('qualification', $academicStaff->qualification) }}"
                       class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
            </div>
            ...
            <div>
                ...
                <textarea name="biography" rows="4"
                          class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none resize-none rich-editor">{{ old('biography', $academicStaff->biography) }}</textarea>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email</label>
                    <input type="email" name="email" value="{{ old('email', $academicStaff->email) }}"
                           class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Phone</label>
                    <input type="text" name="phone" value="{{ old('phone', $academicStaff->phone) }}"
                           class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    @if($academicStaff->profile_image)
                        <div class="mb-2 flex items-center gap-3">
                            <img src="{{ Storage::url($academicStaff->profile_image) }}"
                                 class="w-14 h-14 rounded-full object-cover border border-gray-200 dark:border-gray-600" alt="Current photo">
                ...
                <div>
                    ...
                    <input type="number" name="display_order" value="{{ old('display_order', $academicStaff->display_order) }}" min="0"
                           class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
            </div>
