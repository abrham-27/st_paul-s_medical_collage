...
@section('title', 'Medicine — Edit Department')
@section('page-title', 'School of Medicine · Edit Department')
...
<div class="py-6 max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.medicine.departments.update', $department) }}" enctype="multipart/form-data" class="space-y-6">
            @csrf @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $department->name) }}"
                       required
                       placeholder="e.g. Basic Sciences Departments"
            ...
            <div>
                ...
                <input type="text" name="slug" value="{{ old('slug', $department->slug) }}"
                       required
                       placeholder="e.g. basic"
                       class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">URL-friendly identifier (e.g., basic, clinical)</p>
            </div>
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          ...
                          class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none resize-y rich-editor">{{ old('description', $department->description) }}</textarea>
            </div>
            ...
            <div>
                ...
                @if($department->icon)
                    <div class="mb-2">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Current icon — upload new to replace.</p>
                    </div>
                @endif
            ...
            <div>
                ...
                @if($department->image)
                    <div class="mb-2">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Current header image — upload new to replace.</p>
                    </div>
                @endif
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="display_order" value="{{ old('display_order', $department->display_order) }}"
                           min="0"
                           class="w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none">
                </div>
                <div class="flex items-center pt-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="status" value="1" {{ $department->status ? 'checked' : '' }}
