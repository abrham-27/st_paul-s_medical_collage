...
@section('title', 'Medicine — Partnership Page')
@section('page-title', 'School of Medicine · Partnership')
...
<div class="py-6 max-w-3xl">
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">
        This page manages the Partnership content for the School of Medicine.
    </p>

    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.medicine.partnership.update') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf @method('PUT')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $page->title) }}"
                           placeholder="e.g. Our Partnerships"
