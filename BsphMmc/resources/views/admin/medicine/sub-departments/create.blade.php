...
@section('title', 'Medicine — Add Sub-department')
@section('page-title', 'School of Medicine · Add Sub-department')
...
<div class="py-6 max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.medicine.sub-departments.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
