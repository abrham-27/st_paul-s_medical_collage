...
@section('title', 'Medicine — Add Academic Unit')
@section('page-title', 'School of Medicine · Add Academic Unit')
...
<div class="py-6 max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.medicine.academic-units.store') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="sub_department_id" required
                    ...
                    @foreach($subDepartments as $sub)
                        <option value="{{ $sub->id }}" {{ old('sub_department_id') == $sub->id ? 'selected' : '' }}>
