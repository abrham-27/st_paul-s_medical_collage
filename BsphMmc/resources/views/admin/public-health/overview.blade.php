...
@section('title', 'Public Health — Overview Page')
@section('page-title', 'School of Public Health · Overview')
...
<div class="py-6 max-w-3xl">
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-6">
        This page merges the About, Mission, and Vision sections into one Overview page for the School of Public Health.
    </p>

    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.public-health.overview.update') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf @method('PUT')
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="title" value="{{ old('title', $page->title) }}"
                               placeholder="e.g. About School of Public Health"
