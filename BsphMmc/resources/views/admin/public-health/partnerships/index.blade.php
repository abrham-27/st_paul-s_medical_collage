...
@section('title', 'Public Health — Partnerships')
...
<div class="py-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage partnership and collaboration entries for the School of Public Health</p>
        </div>
        <a href="{{ route('admin.public-health.partnerships.create') }}"
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                    ...
                    <td class="px-5 py-3 text-right">
                        <div class="flex items-center justify-end gap-2">
                            <a href="{{ route('admin.public-health.partnerships.edit', $partnership) }}"
                               class="p-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-lg transition">
                                <i class="fa-solid fa-pen"></i>
                            </a>
                            <form method="POST" action="{{ route('admin.public-health.partnerships.destroy', $partnership) }}" class="inline">
                                @csrf @method('DELETE')
                                <button type="submit"
