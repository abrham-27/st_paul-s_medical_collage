...
@section('title', 'Nursing — Add Partnership')
@section('page-title', 'School of Nursing · Add Partnership')
...
<div class="py-6 max-w-3xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
        <form method="POST" action="{{ route('admin.nursing.partnerships.store') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @include('admin.nursing.partnerships._form')
