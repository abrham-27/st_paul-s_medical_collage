...
@section('title', 'Nursing — Partnership & Collaboration')
...
<div class="py-6 max-w-3xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <form method="POST" action="{{ route('admin.nursing.partnership.update') }}" enctype="multipart/form-data" class="space-y-5">
            @csrf @method('PUT')
