...
@section('title', 'Create Process Step - Admin')
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-4">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900 dark:text-white">Create Process Step</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="p-6">
                <form action="{{ route('admin.offices.registrar.process.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
