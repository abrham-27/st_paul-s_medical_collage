...
@section('title', $officeName . ' · About')

@section('content')
<div class="py-6">
    <div class="max-w-4xl mx-auto space-y-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $officeName }} · About</h1>
            <p class="text-sm text-gray-500 dark:text-gray-400">Manage the about section content for {{ $officeName }}.</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <form action="{{ route('admin.offices.generic.about.update', ['office' => $office]) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
