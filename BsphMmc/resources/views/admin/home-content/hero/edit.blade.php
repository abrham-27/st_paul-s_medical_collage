...
<div class="py-6 max-w-4xl">
    <form method="POST" action="{{ route('admin.home-content.hero.update', $hero) }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="description" rows="5"
                          class="rich-editor w-full px-4 py-2.5 text-sm border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none resize-y">{{ old('description', $hero->description) }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-5">
            ...
            <div>
                ...
                @if($hero->image)
                    <div class="mt-3">
                        <img src="{{ $hero->image_url }}" alt="{{ $hero->title }}" class="w-full max-h-64 object-cover rounded-lg border border-gray-200 dark:border-gray-600">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-5">
            ...
            <div>
                ...
                <input type="number" name="display_order" value="{{ old('display_order', $hero->display_order) }}" min="0"
            ...
            <div class="flex items-center gap-3">
                <input type="checkbox" name="status" value="1" {{ old('status', $hero->status) ? 'checked' : '' }}
        ...
        <div class="flex items-center gap-3">
            ...
            <form method="POST" action="{{ route('admin.home-content.hero.destroy', $hero) }}" class="inline"
