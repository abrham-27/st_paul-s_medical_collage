...
@section('page-title', 'Featured Section')

@section('content')
<div class="py-6 max-w-6xl">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-bold text-gray-900 dark:text-white">Featured Slides Manager</h2>
        <a href="{{ route('admin.home-content.featured.create') }}"
    ...
    @if($slides->isEmpty())
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-12 text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-4">No featured slides yet. Create one to get started.</p>
            <a href="{{ route('admin.home-content.featured.create') }}"
    ...
    @else
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                            ...
                            <div class="lg:col-span-1 flex items-center justify-end gap-2">
                                <a href="{{ route('admin.home-content.featured.edit', $slide) }}"
                                ...
                                <form method="POST" action="{{ route('admin.home-content.featured.destroy', $slide) }}" class="inline"
        ...
        <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            <p class="text-sm text-blue-800 dark:text-blue-200">
                ...
                Slides are displayed in order. You can reorder them by editing and changing the order number.
            </p>
        </div>
    @endif
</div>
