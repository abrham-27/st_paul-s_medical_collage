...
@section('title', 'Create Featured Slide')
@section('page-title', 'Create New Featured Slide')

@section('content')
<div class="py-6 max-w-4xl">
    <form method="POST" action="{{ route('admin.home-content.featured.store') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
